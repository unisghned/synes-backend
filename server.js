...
async function sendTicketEmail(ticket) {
    // A. Buat QR Code berisi ID Tiket
    ...
    let transporter = nodemailer.createTransport({
        service: 'gmail',
        auth: {
            user: 'cumabacafypdoang@gmail.com', // <--- GANTI: Email Gmail kamu
            pass: 'ztrpypclgntlvyma'   // <--- GANTI: 16 karakter tanpa spasi dari Langkah 1
        }
    });
        ...
        html: `
            <div style="font-family: Arial, sans-serif; max-width: 500px; margin: auto; padding: 20px; border: 1px solid #e2e8f0; border-radius: 12px; background-color: #ffffff;">
                ...
                <div style="text-align: center; background: #f8fafc; padding: 20px; border-radius: 8px; margin: 20px 0;">
                    ...
                    <img src="${qrCodeImage}" alt="QR Code Ticket" style="width: 200px; height: 200px; border: 4px solid #ffffff; border-radius: 8px;"/>
                </div>
